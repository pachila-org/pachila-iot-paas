...
require_once(APP_PATH . '/Common/Common/strings.php');
require_once(APP_PATH . '/Common/Common/redispool.php');
...
function call_3rd_service($url, $method='GET', $param=array(), $header=array(), $postdata='') {
	$opts = array(
			CURLOPT_TIMEOUT        => 30,
