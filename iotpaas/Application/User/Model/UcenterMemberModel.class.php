...
class UcenterMemberModel extends Model
{
    ...
    public function register($username, $nickname, $password, $email, $mobile, $type=1)
    {
        ...
        \Think\Log::write('register '.$username.' '.$password.' '.$email.' '.$mobile);
        ...
        if ($usercenter_member) {
            ...
            if ($result > 0) {
                ...
                \Think\Log::write('register return 1');
                return $uid ? $uid : 0; //0-未知错误，大于0-注册成功
            } else {
            	\Think\Log::write('register return 2:'.$result);
                return $result;
            }
        } else {
        	\Think\Log::write('register return 3');
    ...
    public function login($username, $password, $type = 1)
    {
        ...
        \Think\Log::write('Login check_action_limit ...');
