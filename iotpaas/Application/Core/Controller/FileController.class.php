...
class FileController extends Controller
{
    ...
    {
    	\Think\Log::write('FileController.upload1');
        ...
        \Think\Log::write('FileController.upload2');
        ...
        \Think\Log::write('FileController.upload3');
        /* 返回JSON数据 */
    ...
    public function uploadFile()
    {
    	...
    	/* 调用文件上传组件上传文件 */
    	$File = D('Admin/File');
    	$driver = C('DOWNLOAD_UPLOAD_DRIVER');
    ...
    {
        //TODO: 用户登录检测
    	\Think\Log::write('FileController.upload6');
